...
export default function Home(){
  ...
  return (
    <>
    <Head>
   <title>RevoLend - Unlock Effortless Lending and Borrowing on the Swell Ecosystem</title>
   <link rel="shortcut icon" href="/favicon.ico" />
   </Head>
   <div>
   <Header />
   <div className='lg:px-[8%] px-[5%] lg:pt-[5cm] pt-[3cm]' style={{backgroundImage:"url(images/bg9.jpg)", backgroundPositionX:"10%", backgroundRepeat:"no-repeat", transition:"0.3s ease-in-out"}}>


   <div className='lg:mx-[-8%] mx-[-5%]  lg:pb-[30%] pb-[100%] firstsectiondiv'>
   <div className='text-center text-[170%] lg:text-[230%] md:text-[180%] pt-[1.5cm] font-[500]'>Scaling EVM-Compatible Solutions with Swell</div>
   <div className='mt-[1cm] text-center lg:text-[140%] text-[120%] lg:mx-[20%] md:mx-[10%] mx-[5%] p-[0.5cm] lg:px-[2cm] text-[#ccc] bg-[rgba(0,0,0,0.95)]' style={{border:"1px solid #209"}}>
    <div data-aos="fade-in" className='info1' style={{transition:"0.5s ease-in-out"}}>
      Lending: RevoLend enables DeFi users to participate in peer-to-peer lending and borrowing using supported tokens through our innovative decentralized lending/borrowing dApp. Lenders can earn attractive interest rewards, while enjoying a seamless and intuitive user experience. The platform features a decentralized chat system, a swap powered by ChainLink oracles, advanced search capabilities, and smooth pagination for easy navigation. Backed by a rigorously audited security algorithm, RevoLend ensures your funds remain secure at all times.
    </div>
    <div data-aos="fade-in" className='info2' style={{transition:"0.5s ease-in-out"}}>
      Borrowing: Borrowing on RevoLend is simple and hassle-free. Users can initiate a loan request from the Borrow section by providing collateral and agreeing to repay the amount with interest. Lenders can then fund these loan requests promptly. To enhance the user experience, RevoLend includes dedicated sections such as "View All Available Loans", "View Loans You Funded", and "View Loans You Created" for easy tracking and management of loan activities.
    </div>
   </div>
   <div className='mt-[1cm] text-center' style={{transition:"0.3s ease-in-out"}}>
    ...
    <Link href="https://github.com/jerydam/Revolend/blob/main/README.md"><button className='m-[0.2cm] rounded-md bg-[#111] px-[0.3cm] py-[0.2cm] text-[#fff] generalbutton docbutton' style={{border:"2px solid #209"}}>Documentation <img src="images/documentation.png" width="25" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link>
   </div>
