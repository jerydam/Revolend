...
export default function Dashboard(){
  ...
  return (
    <>
    <Head>
   <title>RevoLend Dashboard - Unlock RevoLend's Ecosystem</title>
   ...
   <div>
    ...
    <div className='dashboardmenulg h-[100%] bg-[#111] text-[#fff]' style={{zIndex:"999", position:"fixed", boxShadow:"2px 2px 2px 2px #209", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       <Link href="/"><img src="images/logo2.png" width="40" style={{display:"inline-block"}}/></Link>
       <Link href="https://swell-testnet-explorer.alt.technology"><img src="images/swell.svg" width="32" className='ml-[0.5cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
     </div>
      <div>
      ...
      <div className='mt-[15%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/jerydam/Revolend/blob/main/README.md"><button className='m-[0.2cm] rounded-md bg-[#209] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
       <Link href="https://discord.com/invite/swellnetworkdao"><img src="images/discord.png" width="35" className='m-[0.2cm]' style={{display:"inline-block"}}/></Link>
       <Link href="https://twitter.com/swellnetworkio"><img src="images/twitter.png" width="35" className='m-[0.2cm]' style={{display:"inline-block"}}/></Link>
      </div>
   </div>
   ...
   <div className='w-[70%] h-[100%] bg-[#111] text-[#fff]' data-aos="fade-right" style={{boxShadow:"2px 2px 2px 2px #209", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       <Link href="/"><img src="images/logo2.png" width="40" onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
       <Link href="https://swell-testnet-explorer.alt.technology"><img src="images/swell.svg" width="32" className='ml-[0.3cm] rounded-[100%]' onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
     </div>
      <div>
      ...
      <div className='mt-[15%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/jerydam/Revolend/blob/main/README.md"><button onClick={(e) => setMountSmallMenu(false)} className='m-[0.2cm] rounded-md bg-[#209] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
       <Link href="https://discord.com/invite/swellnetworkdao"><img src="images/discord.png" width="35" className='m-[0.2cm]' onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
       <Link href="https://twitter.com/swellnetworkio"><img src="images/twitter.png" width="35" className='m-[0.2cm]' onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
      </div>
   </div>
   </div>) : (<span></span>)}
   ...
   <div className='w-[100%]'>
   <img src="images/swell.svg" width="100" className='lg:mt-[10%] mt-[20%] ml-[5%] rounded-[100%] blurimage1' style={{position:"absolute"}} />
   <img src="images/swell.svg" width="100" className='lg:mt-[15%] mt-[25%] lg:ml-[85%] ml-[65%] rounded-[100%] blurimage2' style={{position:"absolute"}} />
   <img src="images/logo2.png" width="100" className='lg:mt-[35%] mt-[100%] ml-[8%] blurimage2' style={{position:"absolute"}} />
   <img src="images/logo2.png" width="100" className='lg:mt-[45%] mt-[105%] lg:ml-[85%] ml-[50%] blurimage1' style={{position:"absolute"}} />
   </div>
