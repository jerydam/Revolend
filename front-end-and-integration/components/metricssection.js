...
export default function MetricsSection() {
    ...
    return (
        <div>
        <div className="font-[500] bg-[#502] px-[0.4cm] py-[0.15cm] rounded-md mb-[0.2cm]" style={{display:"inline-block", boxShadow:"2px 2px 2px 2px #333"}}>Revolend Metrics</div>
        <div className="text-[#ccc] text-[90%]">View current status of Revolend</div>
        ...
        <div className="text-center mt-[0.7cm] bg-[#000] p-[0.5cm] rounded-xl" style={{boxShadow:"2px 2px 2px 2px #333"}}>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
                <div className="font-[500] text-[110%]">NXF Total Supply</div>
                {totalTokenSupply ? (<div className="text-[#aaa] lg:w-[100%] md:w-[100%] w-[7cm] overflow-auto">{Intl.NumberFormat().format(parseFloat(totalTokenSupply).toFixed(10))} NXF</div>) : (<span>0</span>)}
            </div>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
            ...
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
                ...
                <div className="text-[#aaa]">CrossFi Testnet</div>
            </div>
            <div className="text-center m-[0.4cm]" style={{display:"inline-block"}}>
        ...
        <div className="mt-[0.5cm] bg-[#000] p-[0.5cm] rounded-xl" style={{boxShadow:"2px 2px 2px 2px #333"}}>
            ...
            <div className="m-[0.4cm]">
             <div className="font-[500] text-[#fff] bg-[#00f] px-[0.4cm] py-[0.1cm] rounded-md mb-[0.2cm]" style={{display:"inline-block"}}>NXF Contract Address</div>
