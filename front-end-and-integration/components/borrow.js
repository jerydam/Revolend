 ...
 useEffect(()=>{
  ...
  getTheData();  
    ...
    return (
        ...
        <div className="text-[#ccc] text-[90%]">Borrow on Revolend (P2P)</div>
        
        <div className="my-[1cm] bg-[#000] p-[0.5cm] rounded-xl lg:mx-[10%] md:mx-[10%]" style={{boxShadow:"2px 2px 2px 2px #00f"}}>
          <div className="mb-[0.5cm] text-center">To borrow XFI, create a loan. Another Revolend user will fund your loan. (P2P)</div>
        ...
        <form>
         ...
         <div className="grid-cols-1">
          ...
          <div className="mt-[0.5cm]"><input type="radio" id="NXF" name="collateralAddress" value={tokenContractAddress} onChange={(e) => setCollateralAddress(e.target.value)} /><span className="ml-[0.3cm]">NXF</span></div>
